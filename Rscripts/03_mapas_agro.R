...
ggsave('Outputs/03_mapas/Agropecuária/03_sintese_agro.png')
...
y <- c('Empregos formais da agropecuária','Médios e grandes estabelecimentos \n da agropecuária',
...
(mapa.3 | mapa.5)/
(mapa.4 | mapa.6)
ggsave('Outputs/03_mapas/Agropecuária/indicadores_juntos_agro.png', scale = 3)