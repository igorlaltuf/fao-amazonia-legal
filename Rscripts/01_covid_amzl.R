...
# Tabela AMZL e classficação apenas da AMZL
...
gtsave(tabela.covid, 'Outputs/03_mapas/Saúde/tabela_covid_intermediadoras.png')


# mapa AMZL com classificação apenas na amzl
...
ggsave('Outputs/03_mapas/Saúde/covid_obitos_amzl.png', width = 9, height = 6)
